...
# gold_production.transport_operations_bus_ticketing.ticketer_all_operators

gold_ticketer_sql = "SELECT * FROM gold_production.transport_operations_bus_ticketing.ticketer_all_operators"
...
date_range_sql = " WHERE Scheduled_Start_Date BETWEEN '2026-05-04' AND '2026-05-10'"
...
sql_string = gold_ticketer_sql + date_range_sql
...
df.write_csv("./gold_ticketer_20260504-20260510.csv")
